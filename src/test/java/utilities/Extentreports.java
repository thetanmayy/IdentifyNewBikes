...
public class Extentreports implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Zigwheels Report"); // Title of report
		sparkReporter.config().setReportName("Zigwheels Functional Testing"); // name of the report
